...
def var(input, dim=None, correction=1, keepdim=False, *, dtype=None, out=None):
    ...
    kernel(input_permuted, temp_var, num_elements, correction)
    ...
    if keepdim:
        ...
        final_shape = [input.shape[i] for i in non_target_dims]
