...
class TestTriu:
    ...
    def test_square(self, n):
        ...
        ninetoothed_output = ntops.torch.triu(input)
        reference_output = torch.triu(input)
    ...
    def test_diagonal(self, diagonal):
        ...
        ninetoothed_output = ntops.torch.triu(input, diagonal)
        reference_output = torch.triu(input, diagonal)
